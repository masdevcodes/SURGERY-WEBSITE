  ...
  return (
    <section id="info" className="py-24 bg-gradient-to-b from-white via-white/0 to-white">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-teal-500 rounded-lg p-6 text-white">
            ...
            <div className="mt-8 pt-8 border-t border-white/50">
              ...
              <p className="text-sm font-light">We provide flexible OPD scheduling for your convenience</p>
              <button className="mt-6 w-full border border-white rounded-md py-3 font-bold text-sm">SUGGEST OPD TIME</button>
            </div>
          </div>
          ...
          <div className="bg-blue-600 rounded-lg p-6 text-white">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center border-b border-white/50 py-4">
                ...
                <span className="bg-green-500 text-white rounded-md px-4 py-2 font-bold text-sm">Available</span>
              </div>
              <div className="flex justify-between items-center border-b border-white/50 py-4">
                <div>
              ...
              <div className="flex justify-between items-center pt-4">
                <p className="font-semibold">Emergency Operations</p>
                <p className="text-green-300">24/7 Available</p>
              </div>
            </div>
          </div>

          {/* Covid-19 Response Card - Moved to third column */}
        ...
        {/* Visitors & Patients Information - Now as a separate row */}
        <div className="mt-16">
          <div className="rounded-lg shadow-lg overflow-hidden max-w-md mx-auto">
            <Image
              src="https://placehold.co/385x321"
