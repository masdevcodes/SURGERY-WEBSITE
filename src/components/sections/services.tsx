...
export function Services() {
  ...
  // Left-side carousel images with optimized sizes
  const carouselImages = [
    { src: '/service11.png', width: 800, height: 600 },
    { src: '/service12.png', width: 800, height: 600 },
    { src: '/service13.png', width: 800, height: 600 },
  ];
  ...
  const OptimizedImage = ({ 
    ...
    <Image
      ...
      placeholder="blur"
      blurDataURL="data:image/jpeg;base64,"
    />
  );
    ...
    >
      ...
      <div className="absolute inset-0 opacity-20">
        <OptimizedImage
          ...
          sizes="100vw"
          priority={true} // Critical background image
        />
